...
# Optional: Allow all origins in development (be careful in production)
if DEBUG:
...
CACHES = {
    'default': {
        ...
        'OPTIONS': {
            ...
            'IGNORE_EXCEPTIONS': True,  # Ignore Redis connection errors in development
        },
...
if DEBUG and 'redis' not in REDIS_URL:
    CACHES['default'] = {
...
SWAGGER_SETTINGS = {
    ...
    'DEFAULT_INFO': 'movie_recommendation.urls.openapi_info',
}
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@movieapp.local')
